   ...
   <div id="form">
	<form action="" method="POST">
      ...
      <input type="radio" id="male"name="pol" value="male" 
        <?php if (isset($values['pol'])&&$values['pol'] == 'male') print("checked"); ?>>
        мужской
      <input type="radio" id="female" name="pol" value="female" 
        <?php if (isset($values['pol'])&&$values['pol'] == 'female') print("checked"); ?>>
        женский<br />
	  
	  <label 
        <?php if(isset($_COOKIE['konechn_error'])) print 'class="error_check"'?>><b>Количество конечностей:</b>
      </label><br />
      <input type="radio" id="1" name="konechn" value="1" 
        <?php if (isset($values['konechn'])&&$values['konechn'] == '1') print("checked"); ?>>
        1
	  <input type="radio" id="2" name="konechn" value="2" 
        <?php if (isset($values['konechn'])&&$values['konechn'] == '2') print("checked"); ?>>
        2
	  <input type="radio" id="3" name="konechn" value="3" 
        <?php if (isset($values['konechn'])&&$values['konechn'] == '3') print("checked"); ?>>
        3
      <input type="radio" id="4" name="konechn" value="4" 
        <?php if (isset($values['konechn'])&&$values['konechn'] == '4') print("checked"); ?>>
        4<br />	
	  ...
	  <label for="info"><b>Биография:</b></label><br />
        <textarea id="info" name="info" 
            <?php if(!empty($errors['info']))  print 'class="error"';?> 
            <?php if(empty($errors['info'])&&!empty($values['info'])) print 'class="ok"';?>>
            <?php isset($_COOKIE['info_error']) ? print trim($_COOKIE['info_error']) : print $values['info'] ?>
        </textarea>
      <br />
      ...
      <label <?php if(!empty($errors['check1'])) print 'class="error_check"'?>>
        <b>я даю согласие на обработку данных</b>
      </label>
